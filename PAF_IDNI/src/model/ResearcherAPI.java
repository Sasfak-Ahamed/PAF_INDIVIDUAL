...
public class ResearcherAPI extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		String output = resObj.insertResearcher(request.getParameter("ProId"),
	...
	protected void doPut(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		Map paras = getParasMap(request);
		 String output = resObj.updateResearcher(paras.get("hidIDSave").toString(),
		 paras.get("ProId").toString(),
		 paras.get("DeveloperName").toString(),
	...
	protected void doDelete(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		Map paras = getParasMap(request);
		 String output = resObj.deleteResearcher(paras.get("ID").toString());
		response.getWriter().write(output);
	}
